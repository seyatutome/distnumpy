...
\begin{figure*}%
  \begin{center}%
    \subfloat[\label{fig:MonteCarloStrong}]{\includegraphics[width=200px]{gfx/MonteCarloStrong}}
    \qquad
    \subfloat[\label{fig:MonteCarloStrongZoomed}]{\includegraphics[width=200px]{gfx/MonteCarloStrongZoomed}}
...
\begin{figure*}%
  \begin{center}%
    \subfloat[\label{fig:JacobiStrong}]{\includegraphics[width=200px]{gfx/JacobiStrong}}
    \qquad
    \subfloat[\label{fig:JacobiStrongZoomed}]{\includegraphics[width=200px]{gfx/JacobiStrongZoomed}}
...
\begin{figure*}%
  \begin{center}%
    \subfloat[\label{fig:NbodyStrong}]{\includegraphics[width=200px]{gfx/NbodyStrong}}
    \qquad
    \subfloat[\label{fig:NbodyStrongZoomed}]{\includegraphics[width=200px]{gfx/NbodyStrongZoomed}}
